...
var (
	...
	// AuthorOrderFieldEmail orders Author by email.
	AuthorOrderFieldEmail = &AuthorOrderField{
		Value: func(a *Author) (ent.Value, error) {
			return a.Email, nil
		},
		column: author.FieldEmail,
		toTerm: author.ByEmail,
		toCursor: func(a *Author) Cursor {
			return Cursor{
				ID:    a.ID,
				Value: a.Email,
...
func (f AuthorOrderField) String() string {
	...
	case AuthorOrderFieldName.column:
		str = "NAME"
	case AuthorOrderFieldEmail.column:
		str = "EMAIL"
	}
	return str
}
